...
for k in range(total):
	...
	for i in range(len(name_R[k])):				
		...
		tmp_reactant.setExponentialDown(176.0)
	...
	for i in range(len(name_TS[k])):	
		...
		tmp_TS.setSigma(5.0)
		tmp_TS.setExponentialDown(176.0)
	...
	for i in range(len(name_P[k])):	
		...
		tmp_product.setExponentialDown(176.0)
	...
	tmp_system.hinderedRotationCorrection(False)
	...
	# fw = file('mesmerInput/' + name_TS[k]+'.xml','w')
